...
public class CommandInterceptor {
    ...
    public static void onCommandEvent(CommandEvent event) {
        ...
        if (source.getEntity() instanceof Player) {
            ...
            if (!PermissionManager.hasPermission(player, "minecraft.command.super") &&
                    !PermissionManager.hasPermission(player, permission)) {

                Component noPermissionMessage = Component.literal("You do not have permission to execute this command.")
